...
function writeToLog(event, value, monsterHelath, playerHealth) {
  ...
  if (event === LOG_EVENT_PLAYER_ATTACK) {
    logEntry.target = 'MONSTER'; //instead of writing the same object in all if else statemtn we declare it in variable and then, and then add dynamically needed property to the object
