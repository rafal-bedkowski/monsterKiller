...
function attackMonster(mode) {
  let maxDamage = mode === MODE_ATTACK ? ATTACK_VALUE : STRONG_ATTACK_VALUE; //if mode is === to MODE_ATTACK assign value ATTACK_VALUE, if not assign the STRONG_ATTACK_VALUE
  let logEvent;
  // if (mode === MODE_ATTACK) {
